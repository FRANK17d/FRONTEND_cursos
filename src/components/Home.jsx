      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <div className="inline-block mb-6">
            <div className="w-24 h-24 mx-auto bg-gradient-to-br from-blue-500 to-green-500 rounded-3xl flex items-center justify-center shadow-2xl transform hover:scale-110 transition-transform">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="flex items-center gap-2 bg-white shadow-lg px-6 py-3 rounded-full border-2 border-green-200">
              <span className="text-green-500 text-2xl">✓</span>
              <span className="text-gray-700 font-medium">Gestión Completa</span>
            </div>
            <div className="flex items-center gap-2 bg-white shadow-lg px-6 py-3 rounded-full border-2 border-sky-200">
              <span className="text-sky-500 text-2xl">✓</span>
              <span className="text-gray-700 font-medium">Interfaz Moderna</span>
            </div>
            <div className="flex items-center gap-2 bg-white shadow-lg px-6 py-3 rounded-full border-2 border-purple-200">
              <span className="text-purple-500 text-2xl">✓</span>
              <span className="text-gray-700 font-medium">Fácil de Usar</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="group relative bg-white rounded-3xl p-8 border-2 border-blue-100 hover:border-sky-400 transition-all duration-300 hover-lift shadow-xl">
            <div className="absolute inset-0 bg-gradient-to-br from-sky-50 to-blue-50 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
            <div className="relative z-10">
              <div className="text-center mb-6">
                <div className="inline-block p-4 bg-gradient-to-br from-sky-400 to-sky-600 rounded-2xl mb-4 shadow-lg">
                  <svg className="w-14 h-14 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-3">
                <Link
                  to="/categorias"
                  className="block w-full bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white font-bold py-3 px-6 rounded-xl text-center transition-all shadow-lg hover:shadow-xl"
                >
                  Ver Categorías →
                </Link>
                <Link
                  to="/categorias/nueva"
                  className="block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 px-6 rounded-xl text-center transition-all border-2 border-gray-200 hover:border-sky-400"
                >
                  + Nueva Categoría
                </Link>
              </div>
          ...
          {/* Tarjeta de Cursos */}
          <div className="group relative bg-white rounded-3xl p-8 border-2 border-green-100 hover:border-green-400 transition-all duration-300 hover-lift shadow-xl">
